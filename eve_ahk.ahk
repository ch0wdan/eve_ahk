...
result := DllCall("MessageBox","Uint",0,"Str","Activate mining bot?","Str","Eve mining bot - ahkgaming.com","Uint","0x00000034L")
If result=7
	ExitApp
isEveActive()
KeyWait, S, up
...
loop, 30
{
	...
	PixelSearch, x, y, 768, y1, 780, y2, 0xFFFFFF, 20, fast
	if errorlevel {
...
loop {
	...
	PixelSearch, x2, y2, 617, 679, 624, 684, 0xB9BFBA, 25, fast
	if (ErrorLevel) {
		ToolTip
		sleep 500
			gosub roidlock
	...
	PixelSearch, x1, y1, 668, 679, 675, 684, 0xB9BFBA, 25, fast
	if (ErrorLevel) {
		click 814, 218
			sleep 100
			send {F2}
